...
#Region " Db Access "
    Public Function Insert() As Integer
        ...
        While cantpass
            ...
            Dim commandString As String = "Insert into tbl_TypeControl (Name) values ('" & _Name & "'); "
            ...
            Try
                ...
                commandString = "SELECT TOP(1) Id_TypeControl from tbl_TypeControl order by Id_TypeControl desc"
                ObjectCommand = New SqlCeCommand(commandString, ObjectConnection)
    ...
    Public Function Update() As Integer
        ...
        Dim ObjectConnection As SqlCeConnection
        Dim ObjectCommand As SqlCeCommand
        Dim commandString As String = "Update tbl_Column set  Name = '" & _Name & "'"
        ObjectConnection = New SqlCeConnection(_systeme.getConnectionString)
        ObjectConnection.Open()
        ObjectCommand = New SqlCeCommand(commandString, ObjectConnection)
        ObjectCommand.ExecuteNonQuery()
    ...
    Public Function Read(ByVal _idpass As Long) As Boolean
        ...
        Dim ObjectConnection As SqlCeConnection
        Dim ObjectCommand As SqlCeCommand
        Dim commandString As String = "Select * from tbl_TypeControl where Id_TypeControl = " & _idpass & ""
        ObjectConnection = New SqlCeConnection(_systeme.getConnectionString)
        ObjectConnection.Open()
        ObjectCommand = New SqlCeCommand(commandString, ObjectConnection)
        Dim myReader As SqlCeDataReader = ObjectCommand.ExecuteReader()
